...
var LoaderSql = {
	...
	countMemAccounts: 'SELECT COUNT(*)::int FROM accounts a WHERE a."transaction_id" = (SELECT "id" FROM "blocks" ORDER BY "height" DESC LIMIT 1)',
	...
	validateMemBalances: 'SELECT * FROM validate_mem_balances()',
